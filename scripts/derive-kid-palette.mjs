...
// Usage: node scripts/derive-kid-palette.mjs
...
import { Hct, Contrast, hexFromArgb as mdHexFromArgb, argbFromHex, lstarFromArgb, labFromArgb, yFromLstar } from '../frontend/node_modules/@material/material-color-utilities/index.js'
