...
import { PLAYER_SPELLBOOK_POLL_INTERVAL_MS, usePlayerSpellbook } from "../usePlayerSpellbook";
...
const frame = (name: string) =>
  [{ id: 1, name, spells: [{ id: 11, name: `${name} spell` }] }] as unknown as Awaited<
    ReturnType<typeof getPlayerSpellbook>
  >;
