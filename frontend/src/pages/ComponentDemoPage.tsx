...
const spells = [
  {
    ...
    name: "Fireball",
    level: "3rd",
    text: "A bright streak flashes, dealing 8d6 fire damage.",
  },
  {
    id: 2,
    name: "Magic Missile",
    level: "1st",
    text: "Three darts, each dealing 1d4+1 force damage.",
  },
...
export function ComponentDemoPage() {
  ...
  return (
    <div>
      ...
      <p>
        Scratch route for reviewing Task 8 shared components in isolation. Not part of the shipped
        nav.
      </p>
