      ...
      <BrowserLayout
        ...
        list={
          <SearchList
            ...
            status={
              npcsRemote.status === "loading" || npcsRemote.status === "idle"
                ? "loading"
                : npcsRemote.status === "error"
                  ? "error"
                  : "ready"
            }
          />
          ...
          selected ? (
            <div className="npc-browser-detail">
              ...
              <div className="npc-browser-actions">
                <Button variant="secondary" onClick={() => setPullTarget(selected)}>
                  Pull from a monster…
                </Button>
                <Button variant="secondary" onClick={() => setAddToEncounterTarget(selected)}>
                  Add to encounter…
                </Button>
            ...
            <StatePanel
              status="noSelection"
              message="Choose an NPC from the list to see their details."
            />
          )
        }
        editor={
