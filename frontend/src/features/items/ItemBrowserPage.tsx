      ...
      <BrowserLayout
        ...
        list={
          <SearchList
            ...
            status={
              itemsRemote.status === "loading" || itemsRemote.status === "idle"
                ? "loading"
                : itemsRemote.status === "error"
                  ? "error"
                  : "ready"
            }
          />
        ...
        detail={
          selected ? (
            <div className="item-browser-detail">
              ...
              >
                <div className="item-browser-category">
            ...
            <StatePanel
              status="noSelection"
              message="Choose an item from the list to see its details."
            />
          )
        }
        editor={
