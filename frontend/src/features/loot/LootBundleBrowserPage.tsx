...
export function LootBundleBrowserPage() {
  ...
  const handleSaved = (bundle: LootBundle) => {
    setEditorOpen(false);
      ...
      <BrowserLayout
        ...
        list={
          <SearchList
            ...
            status={
              bundlesRemote.status === "loading" || bundlesRemote.status === "idle"
                ? "loading"
                : bundlesRemote.status === "error"
                  ? "error"
                  : "ready"
            }
          />
        ...
        detail={
          selected ? (
            ...
            <StatePanel
              status="noSelection"
              message="Choose a bundle from the list to see its contents and value."
            />
          )
        }
        editor={
