...
export function MonsterEditor() {
  ...
  useEffect(() => {
    ...
    api
      ...
      .catch((error) => {
        if (active)
          setLoadError(error instanceof Error ? error.message : "Failed to load monster.");
      })
      .finally(() => {
  ...
  if (loading) {
    return (
      <div className="monster-editor">
        <StatePanel status="loading" message="Loading monster…" />
      </div>
    );
  }
  ...
  return (
    <div className="monster-editor">
      ...
      <form
        ...
        className="monster-editor-form"
        data-testid="monster-editor-form"
      >
        <fieldset className="monster-editor-fieldset" data-region="identity">
          ...
          <div className="monster-editor-grid">
            ...
            <TextField
              label="CR Note"
              value={form.crNote}
              onChange={(e) => patch({ crNote: e.target.value })}
            />
            <TextField
              label="Experience Points"
              type="number"
              value={form.experiencePoints}
              onChange={(e) => patch({ experiencePoints: e.target.value })}
            />
          </div>
        </fieldset>
        ...
        <fieldset className="monster-editor-fieldset" data-region="defenses">
          ...
          <div className="monster-editor-grid">
            <TextField
              ...
              type="number"
              value={form.acValue}
              onChange={(e) => patch({ acValue: e.target.value })}
            />
            <TextField
              label="AC Note"
              value={form.acNote}
              onChange={(e) => patch({ acNote: e.target.value })}
            />
            <TextField
              label="HP (average)"
              type="number"
            ...
            <TextField
              ...
              onChange={(e) => patch({ hpFormula: e.target.value })}
            />
            <TextField
        ...
        <fieldset className="monster-editor-fieldset" data-region="abilities">
          ...
          <div className="monster-editor-ability-grid">
            <TextField
              label="STR"
              type="number"
              value={form.abilityStr}
              onChange={(e) => patch({ abilityStr: e.target.value })}
            />
            <TextField
              label="DEX"
              type="number"
              value={form.abilityDex}
              onChange={(e) => patch({ abilityDex: e.target.value })}
            />
            <TextField
              label="CON"
              type="number"
              value={form.abilityCon}
              onChange={(e) => patch({ abilityCon: e.target.value })}
            />
            <TextField
              label="INT"
              type="number"
              value={form.abilityInt}
              onChange={(e) => patch({ abilityInt: e.target.value })}
            />
            <TextField
              label="WIS"
              type="number"
              value={form.abilityWis}
              onChange={(e) => patch({ abilityWis: e.target.value })}
            />
            <TextField
              label="CHA"
              type="number"
              value={form.abilityCha}
              onChange={(e) => patch({ abilityCha: e.target.value })}
            />
          </div>
          <TextField
        ...
        <fieldset className="monster-editor-fieldset" data-region="lore">
          ...
          <TextField
            ...
            onChange={(e) => patch({ audioPath: e.target.value })}
          />
        </fieldset>
