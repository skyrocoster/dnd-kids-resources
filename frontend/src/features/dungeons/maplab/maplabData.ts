...
const room23: MapRoom = {
  ...
  cells: [
    ...
    [3, 1],
    [0, 2],
    [1, 2], // notch: [2,2] and [3,2] missing
    [0, 3],
    [1, 3], // notch: [2,3] and [3,3] missing
  ],
};
...
const room99a: MapRoom = {
  ...
  title: "West Wing",
  description:
    "The western wing of a four-room complex. An L-shape interlocking with the East Wing.",
  origin: [0, 0],
  cells: [
    [0, 0],
    [1, 0],
...
const room99b: MapRoom = {
  ...
  title: "East Wing",
  description:
    "The eastern wing of a four-room complex. An L-shape interlocking with the West Wing.",
  origin: [0, 0],
  cells: [
    [3, 0],
    [2, 1],
