...
describe('maplabModel (Stage 4 session state)', () => {
  ...
  describe('layout ID counters (Order 03)', () => {
    ...
    it('normalizeLayout backfills missing counters from the current per-kind maxima', () => {
      ...
      const layout: MapLayout = {
        ...base,
        doors: [{ door_id: 5, cell: [0, 0], side: 'N', hidden: false, locked: false, trapped: false }],
        props: [{ prop_id: 3, kind: 'chest', cell: [0, 0], hidden: false, locked: false, trapped: false }],
        stairs: [
          { stair_id: 2, from: { z: 0, cell: [0, 0] }, to: { z: 1, cell: [0, 0] }, hidden: false, locked: false, trapped: false },
        ],
        portals: [
          { portal_id: 4, z: 0, cell: [0, 0], to: { z: 1, cell: [1, 1] }, hidden: false, locked: false, trapped: false },
        ],
        meta: { cellSizeFt: 5, padding: { top: 3, right: 3, bottom: 3, left: 3 } },
      }
      const normalized = normalizeLayout(layout)
