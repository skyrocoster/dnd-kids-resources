...
export function MapLabViewerOverlays({
  ...
  return (
    <>
      {activeInspectable ? (
        <aside className="maplab-sidebar" aria-label="Selected details">
          <div className="maplab-inspector-panel-container" aria-live="polite">
            <InspectorPanel
              target={activeInspectable}
              adapter={activeAdapter}
              context={
                activeInspectable.kind === "portal" &&
                activeInspectable.portal.to?.dungeon_id !== undefined
      ...
      {activeEncounterId != null && (
        <EncounterDock encounterId={activeEncounterId} onClose={onCloseEncounter} />
      )}
