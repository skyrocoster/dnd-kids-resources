            ...
            <div className="loom-selection-actions">
              ...
              {selectedNode.kind === "beat" && selectedNode.thread_id != null && (
                <>
                  <Button
                    variant="primary"
                    size="compact"
                    onClick={() => onFulfilNode(selectedNode)}
                  >
                    Fulfil Beat
                  </Button>
                  <Button
                    variant="secondary"
                    size="compact"
                    onClick={() => onBankNode(selectedNode)}
                  >
                    Bank Beat
                  </Button>
                  <Button
                    variant="secondary"
                    size="compact"
                    onClick={() => onReplaceNode(selectedNode)}
                  >
                    Replace Beat
                  </Button>
                </>
              ...
              {selectedNode.kind === "session" && (
                <Button
                  variant="secondary"
                  size="compact"
                  onClick={() => onSpawnThread(selectedNode)}
                >
                  Spawn Thread
                </Button>
              )}
              {selectedNode.kind === "end" && (
                <Button
                  variant="secondary"
                  size="compact"
                  onClick={() => onChangeEnding(selectedNode)}
                >
                  Change Ending
                </Button>
              )}
              {selectedNode.kind === "session" && selectedNode.fulfilled_planned_title && (
                <Button
                  variant="secondary"
                  size="compact"
                  onClick={() => onUndoFulfil(selectedNode)}
                >
                  Undo Fulfil
                </Button>
              )}
