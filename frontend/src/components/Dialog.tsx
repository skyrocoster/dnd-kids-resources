        ...
        <BaseDialog.Viewport className="dialog-viewport">
          ...
          >
            <header className="dialog-header">
              <BaseDialog.Title id={titleId} className="dialog-title">{title}</BaseDialog.Title>
              {description && <BaseDialog.Description id={descId} className="dialog-description">{description}</BaseDialog.Description>}
            </header>
