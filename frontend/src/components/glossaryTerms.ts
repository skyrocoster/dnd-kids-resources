...
export function matchGlossaryTerms(text: string, registry: GlossaryRegistry): GlossaryTextNode[] {
  ...
  while (cursor < text.length) {
    ...
    for (const key of sortedKeys) {
      ...
      const afterOk = cursor + key.length >= text.length || !/\w/.test(text[cursor + key.length]);
...
export const ruleGlossaryRegistry: GlossaryRegistry = createGlossaryRegistry([
  {
    term: "advantage",
    definition: "Roll two dice and use the higher one - something is helping you.",
  },
  {
    term: "disadvantage",
    definition: "Roll two dice and use the lower one - something is making it harder.",
  },
  {
    term: "concentration",
  ...
  },
  {
    ...
    definition: "A roll to dodge, resist, or shrug off something bad happening to you.",
  },
  {
    term: "hit points",
  ...
  {
    term: "prone",
    definition: "Knocked down on the ground. It costs part of your move to stand back up.",
  },
  {
    term: "blinded",
