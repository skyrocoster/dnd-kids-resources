...
export function SplitPane({
  ...
  const [leftWidth, setLeftWidth] = useState(() => clamp(storedPreference.leftWidth ?? defaultLeftWidth))
  const [collapsed, setCollapsed] = useState(() => collapsible && storedPreference.collapsed === true)
