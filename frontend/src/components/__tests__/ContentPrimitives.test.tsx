...
describe('content primitives', () => {
  it('toggles accordion panels', async () => {
    ...
    render(<Accordion items={[{ value: 'idea', summary: 'Training idea', content: 'Repeat the move.' }]} />)
  ...
  it('renders scroll content and accessible separator', () => {
    render(<><ScrollArea aria-label="Move history" orientation="both"><p>1. e4 e5</p></ScrollArea><Separator orientation="vertical" /></>)
