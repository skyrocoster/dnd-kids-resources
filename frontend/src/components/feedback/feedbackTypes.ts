...
export const FEEDBACK_VARIANTS: Record<FeedbackSeverity, FeedbackVariant> = {
  information: {
    ...
    tokens: {
      accent: "--md-skill",
      onAccent: "--md-on-skill",
      container: "--md-skill-container",
      onContainer: "--md-on-skill-container",
    },
  },
  success: {
    icon: CircleCheck,
    tokens: {
      accent: "--md-nature",
      onAccent: "--md-on-nature",
      container: "--md-nature-container",
      onContainer: "--md-on-nature-container",
    },
  },
  warning: {
    icon: TriangleAlert,
    tokens: {
      accent: "--md-secondary",
      onAccent: "--md-on-secondary",
      container: "--md-secondary-container",
      onContainer: "--md-on-secondary-container",
    },
  },
  error: {
    icon: CircleX,
    tokens: {
      accent: "--md-error",
      onAccent: "--md-on-error",
      container: "--md-error-container",
      onContainer: "--md-on-error-container",
    },
  },
};
