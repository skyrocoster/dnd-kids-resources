...
describe("canvasGrid", () => {
  describe("cellFromClientPoint", () => {
    it("at scale 1 with zero pan, a point inside a known cell resolves to that cell", () => {
      ...
      const cell53 = cellFromClientPoint(
      ...
      const cell99 = cellFromClientPoint(
    ...
    it("a point one pixel across a cell boundary resolves to the neighbor cell", () => {
      ...
      const justInside0 = cellFromClientPoint(
        { clientX: 63, clientY: 32 },
        viewportRect,
        zoom,
        bounds,
      );
      ...
      const justAfter64 = cellFromClientPoint(
      ...
      const justInside1 = cellFromClientPoint(
        { clientX: 32, clientY: 127 },
        viewportRect,
        zoom,
        bounds,
      );
      ...
      const justAfter128 = cellFromClientPoint(
        { clientX: 32, clientY: 128 },
        viewportRect,
        zoom,
        bounds,
      );
    ...
    it("at a zoomed+panned scale, correctly converts client to cell coordinates", () => {
      ...
      const cell11 = cellFromClientPoint(
        { clientX: 164, clientY: 114 },
        viewportRect,
        zoom,
        bounds,
      );
    ...
    it("negative bounds.minX/minY work correctly", () => {
      ...
      const cellOrigin = cellFromClientPoint(
        { clientX: 320, clientY: 192 },
        viewportRect,
        zoom,
        bounds,
      );
    ...
    it("respects viewport offset (when viewport is not at window origin)", () => {
      ...
      const cell00 = cellFromClientPoint(
      ...
      const cell00b = cellFromClientPoint(
        { clientX: 232, clientY: 182 },
        viewportRect,
        zoom,
        bounds,
      );
