...
// Usage: node frontend/src/tools/generate-md3-tokens.mjs --seed <hex> [--chroma <n>] --role <name>
// Harmonizes seed against primary violet (#d0bcff), derives dark-theme tones 80/20/30/90

import { Blend, Hct } from "../../node_modules/@material/material-color-utilities/index.js";
...
console.log(
  `/* ${result.role} — generated via material-color-utilities from source #${result.seedHex},`,
);
console.log(
  `   Blend.harmonize()'d toward primary seed #d0bcff (hue ${result.hue}, chroma ${result.chroma}),`,
);
