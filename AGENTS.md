...
Five skills in `.opencode/skills/` drive this, read by whichever harness a role runs in (opencode
loads that directory natively): `plan`,
...
Five skills in `.opencode/skills/` implement the Plan → Implement → Reconcile workflow above: `plan`
