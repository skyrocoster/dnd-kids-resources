...
- Spell class/source curation and executable spell mechanics remain owned by `docs/spells_plan.md`.
...
- Dungeon cross-reference pop-outs and persisted passage-session state remain deferred in `docs/dungeon_plan.md`.
...
- **Expected touch set:** `frontend/src/components/`, colocated component tests, and `docs/visual_consistency_plan.md` only.
- **Documentation impact:** `docs/visual_consistency_plan.md` only: this inert scaffolding stage creates no durable product contract.
...
- **Expected touch set:** `frontend/src/theme.css`, `frontend/src/index.css`, token tests, `docs/DESIGN_SYSTEM.md`, and `docs/visual_consistency_plan.md`.
- **Documentation impact:** `docs/DESIGN_SYSTEM.md` and `docs/visual_consistency_plan.md` record the durable token, typography, and compact-control contracts.
...
- **Expected touch set:** shared components and form controls, their tests, `docs/DESIGN_SYSTEM.md`, and `docs/visual_consistency_plan.md`.
- **Documentation impact:** `docs/DESIGN_SYSTEM.md` and `docs/visual_consistency_plan.md` record shared primitive and accessibility contracts.
...
- **Expected touch set:** `frontend/src/components/Dialog*`, `ConfirmDialog*`, related tests, `docs/DESIGN_SYSTEM.md`, and `docs/visual_consistency_plan.md`.
- **Documentation impact:** `docs/DESIGN_SYSTEM.md` and `docs/visual_consistency_plan.md` record the modal accessibility contract.
...
- **Documentation impact:** `docs/ARCHITECTURE.md`, `docs/DESIGN_SYSTEM.md`, and `docs/visual_consistency_plan.md` record shell and route-heading conventions.
...
- **Documentation impact:** `docs/visual_consistency_plan.md`; update `docs/DESIGN_SYSTEM.md` only for a confirmed durable shared-contract correction.
...
- **Expected touch set:** shared browser-layout scaffolding, skipped browser tests, and `docs/visual_consistency_plan.md` only.
- **Documentation impact:** `docs/visual_consistency_plan.md` only: inert scaffolding creates no durable product contract.
...
- **Documentation impact:** `docs/ARCHITECTURE.md` and `docs/visual_consistency_plan.md` record the shared browser and responsive navigation convention.
...
- **Documentation impact:** `docs/visual_consistency_plan.md`; update `docs/DESIGN_SYSTEM.md` only if a supported shared visual variant changes.
...
- **Documentation impact:** `docs/ARCHITECTURE.md` and `docs/visual_consistency_plan.md` record any durable route-flow convention.
...
- **Documentation impact:** `docs/DESIGN_SYSTEM.md` and `docs/visual_consistency_plan.md` record any durable shared form or dialog contract.
...
- **Documentation impact:** `docs/visual_consistency_plan.md`; update `docs/DESIGN_SYSTEM.md` only for a proven reusable shared picker or form contract.
...
- **Documentation impact:** `docs/visual_consistency_plan.md`; update `docs/DESIGN_SYSTEM.md` only for confirmed shared-contract corrections.
...
- **Expected touch set:** inert live-surface style/test seams and `docs/visual_consistency_plan.md` only.
- **Documentation impact:** `docs/visual_consistency_plan.md` only: inert scaffolding creates no durable product contract.
...
- **Documentation impact:** `docs/DESIGN_SYSTEM.md` and `docs/visual_consistency_plan.md` record any durable control-size or live-surface accessibility contract.
...
- **Documentation impact:** `docs/ARCHITECTURE.md`, `docs/DESIGN_SYSTEM.md`, and `docs/visual_consistency_plan.md` record durable viewer composition conventions.
...
- **Documentation impact:** `docs/DESIGN_SYSTEM.md` and `docs/visual_consistency_plan.md` record the compact-field accessibility exception.
...
- **Documentation impact:** `docs/visual_consistency_plan.md`; update `docs/DESIGN_SYSTEM.md` or `docs/ARCHITECTURE.md` only for confirmed durable contract corrections.
...
- `docs/design_plan.md` — completed predecessor for site chrome, token generation, icon tooling, and the original
  design-system reference; do not append new work there.
- `docs/spells_plan.md`, `docs/monsters_plan.md`, `docs/encounters_plan.md`, and `docs/dungeon_plan.md` —
  feature-specific preservation and deferred-work boundaries.
- `docs/complete/loot_plan.md` — shipped loot-specific affordances to retain.
