...
| [Frontend Operational Top Row — merge global and surface identity](plans/active/frontend-operational-top-row/frontend-operational-top-row.md) | Plan | Working | Stage 1 shipped the shared operational-row seam and standard PageHeader adoption; Stage 2 Map Lab adoption is next. | When implementing or reviewing FL-02's merged DM application and surface header | A stage ships, or its scope or settled decisions change |
