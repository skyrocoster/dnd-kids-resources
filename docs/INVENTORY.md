...
| [master-plans/frontend-layout-redesign.md](master-plans/frontend-layout-redesign.md) | Master design plan | Working | Agreed | Cross-route DM layout, Map Lab interaction and layout, visible redesign slices, or human UX acceptance gates | A frontend layout decision changes or a focused implementation Plan ships a visible slice |
...
| [Kid Spellbook — Give children a read-only assigned-spell reference](plans/active/kid-spellbook/kid-spellbook.md) | Plan | Working | Stage 1 shipped — spell categories, assigned-spell serialization, the kid bootstrap API, and seed round-tripping are complete; Stage 2 DM category editing is next. | When changing the kid spellbook route, assigned-spell payload, spell categories, or the DM spell editor's category assignment. | A stage ships, or its scope or settled decisions change |
