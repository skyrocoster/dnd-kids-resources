...
| [Contracts/MAPLAB_EDITOR_UX_CONTRACT.md](Contracts/MAPLAB_EDITOR_UX_CONTRACT.md) | Product contract | Working | Agreed | Map Lab editor/viewer UX phases, Smart Room behavior, shared navigation, or contextual-menu scope | A product decision in the Map Lab UX contract changes |
...
| [Kid Spellbook — Give children a read-only assigned-spell reference](plans/active/kid-spellbook/kid-spellbook.md) | Plan | Working | Planned from the agreed readiness contract; implementation has not started. | When changing the kid spellbook route, assigned-spell payload, spell categories, or the DM spell editor's category assignment. | A stage ships, or its scope or settled decisions change |
| [Map Lab component refactor — smaller responsibility-oriented component files](plans/active/maplab-component-refactor/maplab-component-refactor.md) | Plan | Working | Stage 2 shipped; Stage 3 is ready to begin against the preserved viewer contracts. | Splitting or reorganizing oversized Map Lab frontend components without changing the viewer or editor experience. | A stage ships, or its scope or settled decisions change |
