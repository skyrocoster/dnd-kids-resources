...
| [Frontend Operational Top Row — merge global and surface identity](plans/active/frontend-operational-top-row/frontend-operational-top-row.md) | Plan | Working | FL-02 is implemented and all automated gates pass; awaiting explicit human UX acceptance at wide and constrained widths. | When implementing or reviewing FL-02's merged DM application and surface header | A stage ships, or its scope or settled decisions change |
