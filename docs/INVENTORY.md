...
| [Map Lab test suite refactor — smaller, behavior-oriented test files](plans/active/maplab-test-suite-refactor/maplab-test-suite-refactor.md) | Plan | Working | Planned — ready to begin against the shipped Map Obstacle State contracts. | Splitting or reorganizing oversized Map Lab frontend tests without changing product behavior or reducing regression coverage. | A stage ships, or its scope or settled decisions change |
