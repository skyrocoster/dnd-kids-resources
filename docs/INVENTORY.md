...
| [Glossary term tooltips — hover/tap explanations for rule terms in rendered text](plans/active/glossary-term-tooltips/glossary-term-tooltips.md) | Plan | Working | Stages 1-3 shipped. | Glossary term tooltips, rule-term explanations in rendered text | A stage ships, or its scope or settled decisions change |
