...
| [Frontend Operational Top Row — merge global and surface identity](plans/active/frontend-operational-top-row/frontend-operational-top-row.md) | Plan | Working | Stages 1–2 shipped the shared operational row across standard pages and Map Lab; Stage 3 Loom and encounter adoption is next. | When implementing or reviewing FL-02's merged DM application and surface header | A stage ships, or its scope or settled decisions change |
