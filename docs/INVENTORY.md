...
| [Table Testing Records — real sessions become a comparable, checked record](plans/active/table-testing-records/table-testing-records.md) | Plan | Working | Next up for Infra now that Docs Restructure is complete. | Recording a real session, the table-test format, or its lifecycle and checks | A stage ships, or its scope or settled decisions change |
