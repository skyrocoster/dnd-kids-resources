...
| [Map Lab component refactor — smaller responsibility-oriented component files](plans/active/maplab-component-refactor/maplab-component-refactor.md) | Plan | Working | Planned — ready to begin against the shipped Map Obstacle State contracts. | Splitting or reorganizing oversized Map Lab frontend components without changing the viewer or editor experience. | A stage ships, or its scope or settled decisions change |
