...
| [Kid Spellbook — Give children a read-only assigned-spell reference](plans/active/kid-spellbook/kid-spellbook.md) | Plan | Working | Stages 1–2 shipped — categorized spell data and constrained DM category editing are complete; Stage 3 kid spellbook routing, bootstrap, and resilient polling are next. | When changing the kid spellbook route, assigned-spell payload, spell categories, or the DM spell editor's category assignment. | A stage ships, or its scope or settled decisions change |
