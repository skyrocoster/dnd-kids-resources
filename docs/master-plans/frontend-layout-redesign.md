...
| FL-04 | Plan | Implemented; awaiting human acceptance | [Frontend Standard Browser Actions](../plans/active/frontend-standard-browser-actions/frontend-standard-browser-actions.md) adds Monster selected-detail Delete and regression coverage for collection Create plus selected Edit/Delete across all nine standard browsers; focused checks passed. |
