...
| FL-05 | Plan | Browser acceptance failed; repair required | [Map Lab Shared Navigation](../plans/active/maplab-shared-navigation/maplab-shared-navigation.md) passed its focused and full implementation checks, but the 2026-08-07 [shared navigation acceptance script](../FL-05-maplab-navigation-acceptance.md) browser run found broken centering, inconsistent restoration, ineffective empty-space clearing, and incomplete viewer Escape behavior. Repair and rerun the script before recording human acceptance. |
