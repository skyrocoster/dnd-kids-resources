...
| FL-06 | Plan | Implemented; awaiting human acceptance | [Map Lab Command Band](../plans/done/maplab-command-band/maplab-command-band.md) shipped the editor and viewer command-band grammar, responsive rows, native keyboard semantics, and focused regression coverage; automated stage checks passed. |
