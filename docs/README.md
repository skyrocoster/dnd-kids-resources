...
| Story threads, Loom storyline refactor, beats, or session nodes | [The Loom → PA2](plans/active/loom-storyline-refactor.md#pa2-beat-lifecycle-sharing-and-spawning-next-up) | `areas/loom.md`, `DATA_MODEL.md`, `API_REFERENCE.md`, `TESTING.md` |
...
| [areas/loom.md](areas/loom.md) | Area guide | Canonical | PA1 active | Story-thread (Loom) behavior | Loom ownership, source map, or active work changes |
...
| [plans/active/loom-storyline-refactor.md](plans/active/loom-storyline-refactor.md#pa2-beat-lifecycle-sharing-and-spawning-next-up) | Execution plan | Working | PA2 next | Loom storyline refactor (ordered Threads, beats, session nodes) | Its active stage ships or its declared docs change |
