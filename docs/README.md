...
| Story threads, anchors, or the Loom tapestry | [The Loom: LM4](plans/active/loom-tapestry-tracker.md#lm4-react-flow-canvas-read-only-and-themed-next-up) | `areas/loom.md`, `DATA_MODEL.md`, `API_REFERENCE.md`, `TESTING.md` |
...
| [areas/loom.md](areas/loom.md) | Area guide | Canonical | LM4 active | Story-thread (Loom) behavior | Loom ownership, source map, or active work changes |
...
| [plans/active/loom-tapestry-tracker.md](plans/active/loom-tapestry-tracker.md#lm4-react-flow-canvas-read-only-and-themed-next-up) | Execution plan | Working | LM4 next | Current Loom story-thread tracker work | Its active stage ships or its declared docs change |
