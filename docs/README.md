...
| Visual consistency work | [Visual Design: VF5](plans/active/visual-consistency.md#vf5-foundation-design-pass-next-up) | `areas/visual-design.md`, `DESIGN_SYSTEM.md`, `ARCHITECTURE.md`, `TESTING.md` |
...
| [areas/visual-design.md](areas/visual-design.md) | Area guide | Canonical | VF5 active | Shared UI, tokens, shell, or accessibility | Visual routing or active work changes |
| [plans/active/visual-consistency.md](plans/active/visual-consistency.md#vf5-foundation-design-pass-next-up) | Execution plan | Working | VF5 next | Current visual consistency work | Its active stage ships or its declared docs change |
