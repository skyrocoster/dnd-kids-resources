...
| Room label placement or sizing, in either app | [Players](areas/players.md) — [Kid Map Legibility](plans/active/kid-map-legibility/kid-map-legibility.md) Stage 2 shipped the shared label anchor and constant-size kid labels for the kid map and Map Lab | `UX_PATTERNS.md`, `DESIGN_SYSTEM.md`, `TESTING.md`, then the plan |
