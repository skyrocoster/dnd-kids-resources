...
| Story threads, Loom storyline refactor, beats, or session nodes | [The Loom → PC0](plans/active/loom-storyline-refactor.md#pc0-remove-obsolete-modules-migration-and-integration-tests-next-up) | `areas/loom.md`, `DATA_MODEL.md`, `API_REFERENCE.md`, `TESTING.md` |
...
| [areas/loom.md](areas/loom.md) | Area guide | Canonical | PC0 active | Story-thread (Loom) behavior | Loom ownership, source map, or active work changes |
...
| [plans/active/loom-storyline-refactor.md](plans/active/loom-storyline-refactor.md#pc0-remove-obsolete-modules-migration-and-integration-tests-next-up) | Execution plan | Working | PC0 next | Loom storyline refactor (ordered Threads, beats, session nodes) | Its active stage ships or its declared docs change |
