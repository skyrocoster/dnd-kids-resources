...
| Story threads, Loom storyline refactor, beats, or session nodes | [The Loom → PB0](plans/active/loom-storyline-refactor.md#pb0-frontend-types-client-and-scaffolding-next-up) | `areas/loom.md`, `DATA_MODEL.md`, `API_REFERENCE.md`, `TESTING.md` |
...
| [areas/loom.md](areas/loom.md) | Area guide | Canonical | PB0 active | Story-thread (Loom) behavior | Loom ownership, source map, or active work changes |
...
| [plans/active/loom-storyline-refactor.md](plans/active/loom-storyline-refactor.md#pb0-frontend-types-client-and-scaffolding-next-up) | Execution plan | Working | PB0 next | Loom storyline refactor (ordered Threads, beats, session nodes) | Its active stage ships or its declared docs change |
