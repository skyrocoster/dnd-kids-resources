...
| Visual consistency work | [Visual Design: VF2](plans/active/visual-consistency.md#vf2-controls-and-states-next-up) | `areas/visual-design.md`, `DESIGN_SYSTEM.md`, `ARCHITECTURE.md`, `TESTING.md` |
...
| [areas/visual-design.md](areas/visual-design.md) | Area guide | Canonical | VF2 active | Shared UI, tokens, shell, or accessibility | Visual routing or active work changes |
| [plans/active/visual-consistency.md](plans/active/visual-consistency.md#vf2-controls-and-states-next-up) | Execution plan | Working | VF2 next | Current visual consistency work | Its active stage ships or its declared docs change |
