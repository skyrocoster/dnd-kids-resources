...
| Visual consistency work | [Visual Design: VW4](plans/active/visual-consistency.md#vw4-standard-editors-next-up) | `areas/visual-design.md`, `DESIGN_SYSTEM.md`, `ARCHITECTURE.md`, `TESTING.md` |
...
| [plans/active/visual-consistency.md](plans/active/visual-consistency.md#vw4-standard-editors-next-up) | Execution plan | Working | VW4 next | Current visual consistency work | Its active stage ships or its declared docs change |
