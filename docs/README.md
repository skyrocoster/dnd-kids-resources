...
| Visual consistency work | [Visual Design: VW3](plans/active/visual-consistency.md#vw3-action-browsers-next-up) | `areas/visual-design.md`, `DESIGN_SYSTEM.md`, `ARCHITECTURE.md`, `TESTING.md` |
...
| [plans/active/visual-consistency.md](plans/active/visual-consistency.md#vw3-action-browsers-next-up) | Execution plan | Working | VW3 next | Current visual consistency work | Its active stage ships or its declared docs change |
