...
| Story threads, Loom swimlanes redesign, beats, or session nodes | [The Loom: LS2](plans/active/loom-swimlanes-redesign.md#ls2-connector-overlay-next-up) | `areas/loom.md`, `DESIGN_SYSTEM.md`, `ARCHITECTURE.md`, `API_REFERENCE.md`, `DATA_MODEL.md`, `TESTING.md` |
...
| [areas/loom.md](areas/loom.md) | Area guide | Canonical | LS2 active | Story-thread (Loom) behavior | Loom ownership, source map, or active work changes |
...
| [plans/active/loom-swimlanes-redesign.md](plans/active/loom-swimlanes-redesign.md#ls2-connector-overlay-next-up) | Execution plan | Working | LS2 next | Current Loom swimlanes redesign work | Its active stage ships or its declared docs change |
