...
| Story threads, anchors, or the Loom tapestry | [The Loom: LM7](plans/active/loom-tapestry-tracker.md#lm7-remove-the-quests-domain-next-up) | `areas/loom.md`, `DATA_MODEL.md`, `API_REFERENCE.md`, `TESTING.md` |
...
| [areas/loom.md](areas/loom.md) | Area guide | Canonical | LM7 active | Story-thread (Loom) behavior | Loom ownership, source map, or active work changes |
...
| [plans/active/loom-tapestry-tracker.md](plans/active/loom-tapestry-tracker.md#lm7-remove-the-quests-domain-next-up) | Execution plan | Working | LM7 next | Current Loom story-thread tracker work | Its active stage ships or its declared docs change |
