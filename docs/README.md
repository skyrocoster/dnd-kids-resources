...
| The kid-facing app at `/play`, the curtain, fog, what the party has earned, or how the kid map draws rooms, doors, stairs, markers and names | [Players](areas/players.md) — [Kid Map Viewer](plans/active/kid-map-viewer/kid-map-viewer.md) Stage 1 next | `UX_PATTERNS.md`, `DESIGN_SYSTEM.md`, `ARCHITECTURE.md`, `DATA_MODEL.md`, `TESTING.md`, then the plan |
