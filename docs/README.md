...
| Players, recovery profiles, or player spell/weapon rosters | [Players](areas/players.md) — [Player Spellbook Recovery](plans/active/player-spellbook-recovery.md) (Stage 1-4 shipped; Stage 5 next) | `DATA_MODEL.md`, `API_REFERENCE.md`, `UX_PATTERNS.md`, `TESTING.md`, then the plan |
...
| [plans/active/player-spellbook-recovery.md](plans/active/player-spellbook-recovery.md) | Plan | Working | Active (Stage 1-4 shipped) | Player recovery data, spell-first reference, or character assignments | A stage ships, or scope changes |
