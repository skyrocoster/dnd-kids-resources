...
| Visual consistency work | [Visual Design: VT1](plans/active/visual-consistency.md#vt1-encounter-runner-next-up) | `areas/visual-design.md`, `DESIGN_SYSTEM.md`, `ARCHITECTURE.md`, `TESTING.md` |
...
| [areas/visual-design.md](areas/visual-design.md) | Area guide | Canonical | VT1 active | Shared UI, tokens, shell, or accessibility | Visual routing or active work changes |
| [plans/active/visual-consistency.md](plans/active/visual-consistency.md#vt1-encounter-runner-next-up) | Execution plan | Working | VT1 next | Current visual consistency work | Its active stage ships or its declared docs change |
