...
| Story threads, Loom storyline refactor, beats, or session nodes | [The Loom](areas/loom.md) | `areas/loom.md`, `ARCHITECTURE.md`, `API_REFERENCE.md`, `DATA_MODEL.md`, `TESTING.md` |
