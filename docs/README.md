...
| Loom UI/UX (canvas, rail, node visuals) | [Loom Weaver's Workspace: LU0](plans/active/loom-weavers-workspace.md#lu0-scaffolding-next-up) | `areas/loom.md`, `DESIGN_SYSTEM.md`, `TESTING.md` |
...
| [plans/active/loom-weavers-workspace.md](plans/active/loom-weavers-workspace.md#lu0-scaffolding-next-up) | Execution plan | Working | LU0 next | Current Loom UI/UX pass | Its active stage ships or its declared docs change |
