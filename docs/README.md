...
| Story threads, Loom storyline refactor, beats, or session nodes | [Beat Reorder: BR2](plans/active/loom-beat-reorder.md#br2-documentation-update-next-up) | `areas/loom.md`, `DATA_MODEL.md`, `API_REFERENCE.md`, `TESTING.md` |
...
| [areas/loom.md](areas/loom.md) | Area guide | Canonical | BR1 active | Story-thread (Loom) behavior | Loom ownership, source map, or active work changes |
...
| [plans/active/loom-beat-reorder.md](plans/active/loom-beat-reorder.md#br2-documentation-update-next-up) | Execution plan | Working | BR2 next | Drag-to-reorder story beats | Its active stage ships or its declared docs change |
