...
> - **Phase 3 — Dungeon Map Link** (D0–D4): an on-map encounter marker (container/chest style) that opens the runner pop-out, plus Map Lab authoring to attach it. Design pass = the **Dungeon**. D0–D3 complete; D4 (design pass) queued next.
...
> **Status:** Stage D3 (Authoring) **COMPLETE** ✓ (2026-07-13)
