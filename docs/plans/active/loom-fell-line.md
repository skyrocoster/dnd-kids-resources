...
> **Status:** Stage 4 complete — the rail's duplicate Threads list is gone and the inspector surfaces a banked beat's provenance thread. Stage 5 (logging a session) next.
