...
| [Map Lab component refactor](maplab-component-refactor/maplab-component-refactor.md) | [dungeons](../../areas/dungeons.md) | — | ready | none compiled | `to-orders` | Planned — ready to begin against the shipped Map Obstacle State contracts. |
| [Map Lab test suite refactor](maplab-test-suite-refactor/maplab-test-suite-refactor.md) | [dungeons](../../areas/dungeons.md) | — | ready | none compiled | `to-orders` | Planned — ready to begin against the shipped Map Obstacle State contracts. |
...
| [Shared Map Badge Token](shared-map-badge-token/shared-map-badge-token.md) | [design](../../areas/design.md), [dungeons](../../areas/dungeons.md), [players](../../areas/players.md) | — | ready | none compiled | `to-orders` | Stage 1 shipped — DM and player map markers now use the shared badge renderer and geometry; Stage 2 remains to reconcile audience policy helpers and marker-only legacy presentation. |
| [Table Testing Contract](table-testing-contract/table-testing-contract.md) | [infra](../../areas/infra.md) | — | ready | none compiled | `to-orders` | Stage 1 shipped — the canonical reference and blank session template now define compact, independent, question-led records. |
