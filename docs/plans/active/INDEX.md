...
| --- | --- | --- | --- | --- | --- | --- |
| [Map Lab Room Finder](maplab-room-finder/maplab-room-finder.md) | [design](../../areas/design.md), [dungeons](../../areas/dungeons.md) | — | ready | none compiled | `to-orders` | Stage 2 shipped — the editor now uses the shared Room Finder with floor and off-map reachability while preserving authoring workflows; next, compile Stage 3 for viewer integration. |
