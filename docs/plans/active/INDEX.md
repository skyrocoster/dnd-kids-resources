...
| --- | --- | --- | --- | --- | --- | --- |
| [Map Obstacle State](map-obstacle-state/map-obstacle-state.md) | [dungeons](../../areas/dungeons.md) | — | ready | none compiled | `to-orders` | Stage 5 shipped — shared map badge primitives now serve DM and player consumers, DM badges use armed-state policy, and the player map renders one icon-only Trap-or-Lock cue across all fixture kinds. |
...
| [Map Lab component refactor](maplab-component-refactor/maplab-component-refactor.md) | [dungeons](../../areas/dungeons.md) | [Map Obstacle State](map-obstacle-state/map-obstacle-state.md) | blocked | none compiled | `to-orders` | Planned — waiting for Map Obstacle State to finish before changing shared Map Lab components. |
