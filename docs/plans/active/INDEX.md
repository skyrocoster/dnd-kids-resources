...
| [Map Lab test suite refactor](maplab-test-suite-refactor/maplab-test-suite-refactor.md) | [dungeons](../../areas/dungeons.md) | — | ready | none compiled | `to-orders` | Stage 3 shipped — MapLab editor-page and model tests are split into focused suites with duplicate and placeholder coverage removed; ready for the final suite review. |
