...
| --- | --- | --- | --- | --- | --- | --- |
| [Map Lab Relocations](maplab-relocations/maplab-relocations.md) | [design](../../areas/design.md), [dungeons](../../areas/dungeons.md) | — | ready | none compiled | `to-orders` | Stages 1–2 shipped; floor creation lives in the command band and selected-room deletion lives in the inspector. |
