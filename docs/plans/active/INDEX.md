...
| --- | --- | --- | --- | --- | --- | --- |
| [Map Obstacle State](map-obstacle-state/map-obstacle-state.md) | [dungeons](../../areas/dungeons.md) | — | ready | none compiled | `to-orders` | Stage 4 shipped — DM View and DM Edit now share the obstacle inspector with contextual adapters, immediate sparse session writes, authored autosave, rollback, reset, and DC warnings. |
