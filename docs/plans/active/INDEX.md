...
| --- | --- | --- | --- | --- | --- | --- |
| [Map Obstacle State](map-obstacle-state/map-obstacle-state.md) | [dungeons](../../areas/dungeons.md) | — | ready | none compiled | `to-orders` | Stage 6 shipped — the player curtain now emits effective, player-safe fixture facts, filters concealment, and removes loot and authoring fields; the player renderer consumes one Trap-before-Lock cue across all fixture kinds, with focused proof and full repository gates green. |
