...
- [Map Lab Command Band — one labelled tool row with explicit active options](maplab-command-band/maplab-command-band.md) — Completed and accepted 2026-08-09; FL-06 command band is shipped. — (design)
...
- [Map Lab Inspector Presentation — selection-only responsive inspector](maplab-inspector-presentation/maplab-inspector-presentation.md) — Stages 1–2 shipped; focused automated checks passed 42/42, Luna browser diagnostics found no console errors or confirmed failed requests but did not complete the full scripted matrix, and the user explicitly accepted FL-09 on 2026-08-12. — (dungeons)
- [Map Lab Relocations — clear homes for floors, room deletion, and connections](maplab-relocations/maplab-relocations.md) — Completed and accepted 2026-08-11; FL-07 floor creation, selected-room deletion, and connection resolution now have clear homes outside the room rail. — (design)
- [Map Lab Room Finder — replace permanent room navigation](maplab-room-finder/maplab-room-finder.md) — Completed implementation — Stages 1–3 shipped; the viewer now uses the shared Room Finder without a permanent rail or Rooms drawer. — (design)
