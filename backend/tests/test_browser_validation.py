...
spec = importlib.util.spec_from_file_location("browser_validation", ROOT / "src/tools/browser_validation.py")
...
def test_dialog_snapshot_precedes_print_media_and_print_is_reached():
    source = (ROOT / "src/tools/browser_validation.py").read_text(encoding="utf-8")
