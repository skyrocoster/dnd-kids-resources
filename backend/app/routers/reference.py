...
from ..schemas import Ability, Condition, DamageType, Skill, SpellComponent, WeaponProperty
...
@router.get(
    "/weapon_properties", response_model=List[WeaponProperty], operation_id="getWeaponProperties"
)
@cached_get("reference")
...
def get_skills():
    ...
    skills = [
        Skill(
            name="Acrobatics", ability="Dexterity", description="Balance, tumbling, and athletics"
        ),
        Skill(
            name="Animal Handling",
            ability="Wisdom",
            description="Caring for and controlling animals",
        ),
        Skill(
            name="Arcana",
            ability="Intelligence",
            description="Knowledge of spells and magical creatures",
        ),
        ...
        Skill(
            name="Investigation",
            ability="Intelligence",
            description="Finding hidden objects and details",
        ),
        Skill(name="Medicine", ability="Wisdom", description="Diagnosis and treatment of injuries"),
        Skill(
            name="Nature",
            ability="Intelligence",
            description="Knowledge of plants, animals, and terrain",
        ),
        Skill(
            name="Perception", ability="Wisdom", description="Noticing details in your surroundings"
        ),
        Skill(name="Performance", ability="Charisma", description="Entertaining an audience"),
        Skill(
            name="Persuasion", ability="Charisma", description="Convincing others through reasoning"
        ),
        Skill(
            name="Religion",
            ability="Intelligence",
            description="Knowledge of gods and religious practices",
        ),
        Skill(
            name="Sleight of Hand",
            ability="Dexterity",
            description="Picking pockets and palming objects",
        ),
        Skill(name="Stealth", ability="Dexterity", description="Moving quietly and hiding"),
        Skill(
            name="Survival",
            ability="Wisdom",
            description="Tracking and surviving in the wilderness",
        ),
    ]
    return skills
...
@router.get(
    "/spell-components", response_model=List[SpellComponent], operation_id="getSpellComponents"
)
@cached_get("reference")
def get_spell_components():
    ...
    components = [
        SpellComponent(
            code="V", name="Verbal", description="A verbal component is a spoken incantation"
        ),
        SpellComponent(
            code="S", name="Somatic", description="A somatic component is a gesture or motion"
        ),
        SpellComponent(
            code="M", name="Material", description="A material component is a physical object"
        ),
    ]
    return components
